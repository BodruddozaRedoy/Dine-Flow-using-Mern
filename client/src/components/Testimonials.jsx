    ...
    <div className="md:mx-10 mx-3">
      <section className="text-gray-600  body-font w-full">
        <div className=" w-full">
          <h1 className="text-3xl dark:text-white font-medium title-font text-gray-900 mb-12 text-center">
            Testimonials
          </h1>
            ...
            <div className="p-4 md:w-1/2 lg:w-1/3 w-full ">
              <div className="h-full bg-white p-8 rounded dark:bg-slate-400">
                <svg
                  ...
                  fill="currentColor"
                  className="block w-5 h-5 text-gray-400 dark:text-black mb-4"
